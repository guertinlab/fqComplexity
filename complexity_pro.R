...
prefix.name = strsplit(strsplit(complexity.log, "_complexity")[[1]][1], "_noadap_trimmed")[[1]][1]
...
frac.unique.at.10mil = unique.at.10mil/10000000
if (argsLen == 1) {
    system(paste0('echo "',frac.unique.at.10mil,'\t',prefix.name,'\t0.75\tUnique at 10mil" >> ',prefix.name,'_QC_metrics.txt'))
